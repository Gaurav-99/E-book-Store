...
void bookshope::add_book()
{
  ...
  // output mode
  file.open("G://H/Repos/E-book-Store/data/book.txt",
            ios::out | ios::app);
  file << " " << b_id << " "
       << b_name << " " << a_name
       << " " << no_copy << "\n";
...
void bookshope::show_book()
{
  ...
  file.open("G://H/Repos/E-book-Store/data/book.txt", ios::in);
  if (!file)
    cout << "\n\nFile Opening Error!";
  else
  {
...
void bookshope::update_book()
{
  ...
  cout << "\n\n\t\t\t\tUpdate Book Record";
  file1.open("G://H/Repos/E-book-Store/data/book1.txt",
             ios::app | ios::out);
  file.open("G://H/Repos/E-book-Store/data/book.txt", ios::in);
  ...
  file.close();
  file1.close();
  remove("G://H/Repos/E-book-Store/data/book.txt");
  rename("G://H/Repos/E-book-Store/data/book1.txt",
         "G://H/Repos/E-book-Store/data/book.txt");
}
